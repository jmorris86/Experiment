...
instruction_text_1 = f"Thank you for agreeing to take part in this online experiment. \n\nThe experiment takes place" \
					 ...
					 f"groups, A or B. \nWhereas, as a vendor you will be assigned to one of three groups, High Quality," \
					 ...
					 f"£{utility_multiplier}0, 2 star rating results in\n£{2 * utility_multiplier}0 etc."
...
instruction_text_2 = f"\n\nDependent on purchaser and vendor types, purchases have different probabilities of " \
					 ...
					 f" Low Quality vendors is 2.5 stars. \n\nType A purchasers enjoy Specialty purchases and purchases " \
					 f"result in an average of 4 stars,\nwhereas Type B purchasers dislike Specialty products and " \
					 f"purchases result in an average of 2 stars.\n\nIf a product results in a specific rating in a " \
					 f"round, it may not result in the same rating in\na different round. \n\nAt the end of round " \
					 f"{rounds}, purchasers will see a summary of total surplus generated from transactions\nwith each" \
					 f" vendor. Purchasers will then be asked to propose a one time take it or leave it offer to the" \
					 f"\nvendor. Vendors can reject offers,whereby each participant will leave with nothing from the" \
					 f"\ntransaction. If the vendor accepts the offer, purchasers will be remunerated an amount equal" \
					 f" to the\ntotal payoff less the amount given to the vendor."
