...
instruction_text_1 = f"Thank you for agreeing to take part in this online experiment. \n\nThe experiment takes place" \
					 ...
					 f" their satisfaction is then added to the vendor history in the following round. " \
...
instruction_text_2 = f"\n\nDependent on purchaser and vendor types, purchases have different probabilities of " \
					 ...
					 f" Low Quality vendors is 2.5 stars. Type A purchasers\nenjoy Specialty vendors and purchases " \
					 f"result in an average of 4 stars, whereas Type B purchasers\nof Specialty products result in an" \
					 ...
					 f" the total payoff\nless the amount given to the vendor."
