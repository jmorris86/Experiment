...
instruction_text_1 = f"Thank you for agreeing to take part in this online experiment. \n\nThe experiment takes place" \
					 ...
					 f"customers. Vendors not chosen\n by the user are chosen at random by a purchaser of unknown type," \
					 f" their payoff is then\n added to the vendor history in the following round. " \
					 ...
					 f"will leave with nothing. If the vendor\n accepts, purchasers will be " \
					 f"paid total payoff less the amount given to the vendor."

instruction_text_2 = f"The market consists of different types of purchasers and vendors. The market share of" \
...
card_title = canvas.create_text(500, 60, text="Instructions", font=("Ariel", 30, "italic"))
