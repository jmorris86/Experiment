...
instruction_text_2 = f"The market consists of different purchaser and vendor types. Participants types are chosen at " \
					 f"random with \nthe following probabilities:\n\nPurchaser Types Probabilities				Vendor " \
					 f"Types Probabilities" \
					 ...
					 f" productivity for the different types is as follows:\n\n" \
					 f"       Type A				      		Type B\n\nSpecialists - 4 Stars				" \
		...
		if entry_widget1.get() == "Name":
			...
			canvas.itemconfig(card_info,
							  text=f"\n\n{name} you have been randomly assigned to the role of purchaser and are a"
								   f" \nType {Type}.\n\nPlease remember, Type {Type}s receive an average payoff of {word_1} from "
